...
#define DATA_SIZE 6
	...
	enum animal_type input_data[] = { CAT, DOG, COW, PIG, WOLF, LION, DEER, ELEPHANT, ANIMAL_TYPE_COUNT,           ANIMAL_TYPE_COUNT + 1 };
	char *expected_values[] = { "Кіт", "Собака", "Корова", "Свиня", "Вовк", "Лев", "Олень", "Слон","N/A", "N/A" };
